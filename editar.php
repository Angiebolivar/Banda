       ...
       $error["apellidos"]="Los apellidos no son válidos";
        ...
        if(isset($_POST["instrumento"]) && !is_numeric($_POST["instrumento"])){
         ...
         $instrumento_validador=false;
          $error["instrumento"]="Seleccione un instrumento para el estudiante";
           }
...
?>
<h2>Editar Usuario <?php echo $user["user_id"]."-".$user["nombre"]." ".$user["apellidos"];?></h2>
...
<label for="identificacion">Documento de Identidad:
    ...
    <label for="instrumento" class="form-control">instrumento:
        <select name="instrumento">
            <option value="Trompeta"<?php if($user["instrumento"]=="Trompeta"){echo "selected='selected'";}?>>Trompeta</option>
            <option value="Clarinete"<?php if($user["instrumento"]=="Clarinete"){echo "selected='selected'";}?>>Clarinete</option>
            <option value="Saxofon"<?php if($user["instrumento"]=="Saxofon"){echo "selected='selected'";}?>>Saxofon</option>
            <option value="Oboe"<?php if($user["instrumento"]=='Oboe'){echo "selected='selected'";}?>>Oboe</option>
            <option value="Violin"<?php if($user["instrumento"]=='Violin'){echo "selected='selected'";}?>>Violin</option>
            <option value="Bombo"<?php if($user["instrumento"]=='Bombo'){echo "selected='selected'";}?>>Bombo</option>
            <option value="Corno"<?php if($user["instrumento"]=='Corno'){echo "selected='selected'";}?>>Corno</option>
            <option value="Frances"<?php if($user["instrumento"]=='Frances'){echo "selected='selected'";}?>>Frances</option>
        </select>
